...
public class AreaPrincipalSistema {
	...
	public static void main(String[] args) {
		...
		/*Instanciando um objeto Secretário para a interface PermitirAcesso*/
		PermitirAcesso acesso = new Secretario();
		
		if (!login.isEmpty() && login != null && !senha.isEmpty() && senha != null) {

			if ( autenticacao.autenticacao(acesso)) { /*Autorizar quem realmente tem o contrato 100% legitmo*/
